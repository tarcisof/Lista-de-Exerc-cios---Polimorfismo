 ...
 *
 * Para usar uma classe que implementa Map, quaisquer classes que forem utilizadas 
 * como chave devem sobrescrever os métodos hashCode() e equals().
 */
public class ExemploHashMap_001 {
    ...
    private static void exemploListaSimplesIterandoChaveValor() {
        ...
        System.out.println("***** for comum - CONJUNTO *****");
